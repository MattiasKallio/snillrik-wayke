...
class SNWK_shortcodes
{
    ...
    public function wayke_price(){
        ...
        $ret_str = "<div class='snillrik-waykeunder-info'><span class='snillrik-waykeprice'>" .SNWK_DesignElements::format_price($snillrik_price) . " kr</span>Pris:</div>";
        return $ret_str;
    }
    ...
    { 
        ...
        return "<div class='snillrik-waykelist-main'>".$str_out."<div class='snillrik-waykepaginator'>$pageination_str</div></div>";
    }
