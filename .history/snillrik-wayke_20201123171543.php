...
//require_once SNWK_DIR . 'SNWK_Ajax.php';
...
function snillrik_faq_admin_addCSScripts($page){
    wp_enqueue_script 	( 'snillrik-waykewaykeadmin-script', SNWK_PLUGIN_URL . 'js/snillrik-waykewayke-admin.js', array ('jquery' ));
	wp_localize_script  ('snillrik-waykewaykescript', 'snillrik_js', array(
...
function snillrik_faq_addCSScripts(){
	...
	wp_enqueue_style 	( 'snillrik-waykewaykefront', SNWK_PLUGIN_URL . 'css/snillrik-waykewayke-front.css' );
    wp_enqueue_script 	( 'snillrik-waykewaykescript', SNWK_PLUGIN_URL . 'js/snillrik-waykewayke.js', array ('jquery' ));
