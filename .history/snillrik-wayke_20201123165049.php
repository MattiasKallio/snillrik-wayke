...
function snillrik_faq_addCSScripts(){
    wp_enqueue_style    ('snillrik-swiper', SNWK_PLUGIN_URL . 'css/swiper.min.css');
    ...
    wp_enqueue_script 	( 'snillrik-slider-swiper', SNWK_PLUGIN_URL . 'js/swiper.min.js', array ('jquery' ));
    wp_register_script('snillrik-slider-main-script', SNWK_PLUGIN_URL . 'js/snillrik-swiper.js', array('jquery'),'1.2.3', true);
