...
<div class="wrap snillrik-faq">
	...
	<div class="snillrik-waykemain">
		<div class="snillrik-waykerow">
			<div class="snillrik-waykeitem">
				<div class="snillrik-waykeitem-inner">
				<h3><?php esc_attr_e("Token for Wayke","snillrik-faq") ?></h3>
				<p><?php esc_attr_e("The token for communicating with Wayke","snillrik-faq") ?></p>
			...
			<div class="snillrik-waykeitem">
				<div class="snillrik-waykeitem-inner">
				<h3><?php esc_attr_e("Select page for single car page","snillrik-faq") ?></h3>
				<p><?php esc_attr_e("The page for the singe page for a car, the one that has the shortcode [wayke_item]","snillrik-faq") ?></p>
		...
		<h3><?php esc_attr_e("Shortcodes","snillrik-faq") ?></h3>
